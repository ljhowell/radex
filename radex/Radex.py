...
class Radex:
    ...
    def preprocess_data(self, columns='report', **kwargs):
        ...
        if self.data is None:
            raise ValueError("Data has not been loaded. Call read_data() first.")
        ...
        self.preprocessed_data = clean_dataframe(self.data, columns,
    ...
    def run_searches(self):
        ...
        for filter_name, expression in self.searches.items():
            ...
            self.output_data = search_dataframe(self.preprocessed_data, column='report',
